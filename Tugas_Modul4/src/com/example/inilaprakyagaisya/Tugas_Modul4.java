...
public class Tugas_Modul4 {
     static String cetak(String pilihan){
        if(pilihan == "ya"){
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (input == 1) {
                ...
                if (jenisPinjaman == 1){
                    System.out.println("Apakah kamu yakin akan meminjam 2 juta? (ya/tidak) : ");
                    pilih = sc.next();
                    cetak("");
                }else if(jenisPinjaman == 2){
                    System.out.println("Apakah kamu yakin akan meminjam 4 juta? (ya/tidak) : ");
                    pilih = sc.next();
                    cetak("");
                } else{
                    System.out.println("Apakah kamu yakin akan meminjam 6 juta? (ya/tidak) : ");
                    pilih = sc.next();
                    cetak("");
                }
